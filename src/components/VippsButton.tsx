...
const VippsButton = () => {
  return (
    <a
      ...
      onClick={() => trackEvent('click_vipps')}
      className="flex items-center justify-center gap-2 rounded-xl bg-[#FF5B24]/10 px-4 py-2.5 text-sm font-medium text-[#FF5B24] transition-all hover:opacity-90 active:scale-[0.98]"
    >
